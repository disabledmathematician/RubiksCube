...
# Gamma 6 for all possible states, will stochastically and combinatorially allow for 6! possible face directions, but that is implausible as faces are arranged in opposite settings
import sys
